...
class PSMdVRK:
    ...
    def __init__(self, ral, arm_name, ros_namespace="", expected_interval=0.01):
        ...
        if not rospy.get_node_uri():
            rospy.init_node('simplified_psm_class', anonymous=False, log_level=rospy.WARN)
...
jaw_state=yaml.load(open(os.path.join(os.path.dirname(__file__),"JAW2_state.yaml"), 'r'))
